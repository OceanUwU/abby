...
public abstract class AbstractAbbyPotion extends CustomPotion {
    public AbstractPlayer.PlayerClass pool;
    protected PotionStrings strings;

    public AbstractAbbyPotion(String id, PotionRarity rarity, PotionSize size, Color liquidColor, Color hybridColor, Color spotsColor) {
    ...
    public AbstractAbbyPotion(String id, PotionRarity rarity, PotionSize size, Color liquidColor, Color hybridColor, Color spotsColor, AbstractPlayer.PlayerClass pool, Color labOutlineColor) {
