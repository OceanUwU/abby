...
public abstract class AbstractAbbyPower extends AbstractPower {
    ...
    public AbstractAbbyPower(String ID, String NAME, PowerType powerType, boolean isTurnBased, AbstractCreature owner, int amount) {
        this.ID = ID;
        ...
        Texture normalTexture = TexLoader.getTexture(AbbyMod.modID + "Resources/images/powers/" + ID.replaceAll(AbbyMod.modID + ":", "") + "32.png");
        Texture hiDefImage = TexLoader.getTexture(AbbyMod.modID + "Resources/images/powers/" + ID.replaceAll(AbbyMod.modID + ":", "") + "84.png");
        if (hiDefImage != null) {
