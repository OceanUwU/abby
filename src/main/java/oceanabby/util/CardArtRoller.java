...
public class CardArtRoller {
    private static final Texture attackMask = TexLoader.getTexture(AbbyMod.makeImagePath("masks/AttackMask.png"));
    private static final Texture skillMask = TexLoader.getTexture(AbbyMod.makeImagePath("masks/SkillMask.png"));
    private static final Texture powerMask = TexLoader.getTexture(AbbyMod.makeImagePath("masks/PowerMask.png"));
    ...
    public static void computeCard(AbstractAbbyCard c) {
